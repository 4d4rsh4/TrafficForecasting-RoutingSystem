...
def get_route():
    try:
        ...
        # =====================================================================
        # THIS IS THE NEW "HEURISTIC TOPOLOGY TRANSFER" FOR KATHMANDU
        # =====================================================================
        ...
        for u, v, k, data in G.edges(keys=True, data=True):
            ...
            if city_id == 'san_francisco':
                flow = predicted_flows[(u + v) % N] # Pure ML Model
            else:
                # Kathmandu Logic: Model Trend + Local Road Type
