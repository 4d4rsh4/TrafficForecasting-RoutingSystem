# Spatio-Temporal Traffic Forecasting & Routing System (CT707)
...
### 3. Emergency Isochrone Analysis
...
### 4. Interactive Roadblock Simulation 
...
- Traffic heatmap
- Shortest (White) vs AI-optimized (Teal) route comparison
